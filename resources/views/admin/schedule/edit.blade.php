...
@section('breadcumb')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Edit Data Jadwal Travel</h1>
        </div><!-- /.col -->
    </div><!-- /.row -->
@endsection
                ...
                <form action="{{route('admin.schedule.update')}}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="route" id="" class="form-control route-select">
                                ...
                                @foreach ($routes as $route)
                                    <option value="{{$route->id}}" @if($route->id == $schedule->route_id) selected @endif>{{$route->cityDepartureRef->name}}  ->  {{$route->cityArrivalRef->name}}</option>
                                @endforeach
                            </select>
                            @if ($errors->has('route'))
                        ...
                        <div class="form-group">
                            ...
                            <select name="vehicle" id="" class="form-control">
                                ...
                                @foreach ($vehicles as $vehicle)
                                    <option value="{{$vehicle->id}}" @if($vehicle->id == $schedule->vehicle_id) selected @endif>{{$vehicle->vehicle_name}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="date" value="{{$date}}" placeholder="Input tanggal" class="form-control">
                            @if ($errors->has('date'))
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                                <input type="text" name="departure_time" value="{{$schedule->departure_time}}" class="form-control datetimepicker-input" placeholder="00:00 AM" data-target="#datetimepicker1"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="datetimepicker2" data-target-input="nearest">
                                <input type="text" name="arrival_time" value="{{$schedule->arrival_time}}" class="form-control datetimepicker-input" placeholder="00:00 AM" data-target="#datetimepicker2"/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="price" value="{{$schedule->price}}" placeholder="Input Harga" class="form-control">
                            @if ($errors->has('price'))
